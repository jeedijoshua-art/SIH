...
original_resolve_block = """          if (!['go_back', 'go_forward', 'no_op', 'navigate', 'press_key'].includes(step.type)) {
...
new_resolve_block = """          let resolvedElement: HTMLElement | null = null;
          ...
          if (!['go_back', 'go_forward', 'no_op', 'navigate', 'press_key'].includes(step.type)) {
              ...
              // Use our own isElementVisible instead of isVisible since we injected it
